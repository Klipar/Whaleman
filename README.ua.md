...
Саме в момент появи лавиноподібного руху активізується система `whaleman` та починає викуповувати stop-loss ордери разом з китом, що спровокував цю ситуацію, тим самим допомагаючи відновити ринок.
